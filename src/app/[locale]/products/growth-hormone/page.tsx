...
export default async function GrowthHormonePage({ params }: { params: { locale: string } }) {
  const t = await getTranslations({ locale: params.locale, namespace: 'CategoryTemplate' });
  const products = productsData.filter(p => p.category === 'growth-hormone');
      ...
      <section className="relative overflow-hidden py-20 border-b border-white/5">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
          ...
          <p className="text-xl text-gray-400 font-dm-sans leading-relaxed">
            High-purity GHRP and GHRH peptides for endocrinology and metabolic research applications. Synthesized for strict laboratory environments to study the pathways of endogenous growth hormone stimulation.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <details className="group border border-white/10 rounded-xl bg-[#0e131b] overflow-hidden">
            <summary className="p-6 cursor-pointer font-rajdhani font-bold text-xl text-white flex justify-between items-center outline-none">
              About Growth Hormone Secretagogues & Peptides
            ...
            <div className="p-6 pt-0 border-t border-white/5 text-gray-400 font-dm-sans leading-relaxed space-y-4">
              <p>
                Growth Hormone Releasing Peptides (GHRPs) and Growth Hormone Releasing Hormones (GHRHs) are crucial tools in neuroendocrine research. These synthetic analogues are formulated to bind to specific cellular receptors, enabling researchers to investigate the pulsatile release mechanisms of endogenous hormones.
              </p>
              <p>
                Our inventory includes leading secretagogues such as Ipamorelin, Tesamorelin, and various CJC-1295 formulations (both with and without Drug Affinity Complex). By utilizing these high-purity sequences, laboratories can conduct precise studies on metabolic function, cellular proliferation, and endocrine regulation without the complexities introduced by lower-quality or unstable compounds.
              </p>
              <p>
                All our growth hormone research peptides undergo comprehensive third-party testing, including mass spectrometry and HPLC analysis, ensuring structural integrity, accurate mass, and &gt;99% purity. We supply these compounds exclusively to qualified research institutions and B2B partners.
              </p>
            </div>
          </details>
        </div>
