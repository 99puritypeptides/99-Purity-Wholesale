...
export default function GLP1MetabolicPage() {
  const products = [
    {
      name: 'Semaglutide',
    ...
    {
      name: 'Tirzepatide',
      specs: ['10mg × 10 vials', '15mg × 10 vials', '30mg × 10 vials'],
    },
    {
      name: 'Retatrutide',
      specs: ['10mg × 10 vials', '15mg × 10 vials'],
    },
    {
      name: 'Cagrilintide',
      specs: ['5mg × 10 vials'],
    ...
    {
      name: 'Cagrisema',
      specs: ['5mg/5mg × 10 vials'],
    },
    {
      name: 'Dulaglutide',
      specs: ['3mg × 10 vials', '5mg × 10 vials'],
    }
  ];
